...
describe('Service Tests', () => {
  describe('ProcessExecution Service', () => {
    let injector: TestBed;
    let service: ProcessExecutionService;
    let httpMock: HttpTestingController;
    let elemDefault: IProcessExecution;
    let expectedResult: IProcessExecution | IProcessExecution[] | boolean | null;
    ...
    describe('Service methods', () => {
      ...
      it('should create a ProcessExecution', () => {
        ...
        service.create(new ProcessExecution()).subscribe(resp => (expectedResult = resp.body));
      ...
      it('should delete a ProcessExecution', () => {
